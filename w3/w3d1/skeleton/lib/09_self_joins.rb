...
def start_at_craiglockhart
  ...
  execute(<<-SQL)
    ...
    JOIN
      routes AS end_routes ON start_routes.company = end_routes.company AND
        start_routes.num = end_routes.num
    JOIN
      stops AS start_route_stops ON start_route_stops.id = start_routes.stop_id
    JOIN
      stops AS end_route_stops ON end_route_stops.id = end_routes.stop_id
    WHERE
      start_route_stops.name = 'Craiglockhart'
  SQL
end
